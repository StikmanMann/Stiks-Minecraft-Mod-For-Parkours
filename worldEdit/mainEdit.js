import { world, system, ItemStack,  EntityInventoryComponent,  ItemTypes,  ItemEnchantsComponent, Enchantment, BlockTypes } from "@minecraft/server";
import { ActionFormData, ActionFormResponse, ModalFormData } from "@minecraft/server-ui";
import {set, undo, redo, copy, paste} from "./commands.js"
            ...
            if (!eventData.message.startsWith(commandPrefix)) {
                ...
                switch(message.split(" ")[0])
                {
                    ...
                    case ";paint":
                        ...
                        playerInstance.paintRange = Math.floor(message.split(" ")[3])
                        player.playSound("note.pling")
                        break;
                    default:
                       // player.playSound("note.bass")
